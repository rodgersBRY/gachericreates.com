  ...
  return (
    <RevealOnScroll delay={delay}>
      <Link href={href} className="group block">
        ...
        <div className="pt-4">
          <h2 className="font-heading text-heading-3 text-text-primary mb-1">
            {title}
          </h2>
...
const cards: Omit<EntryCardProps, "delay">[] = [
  {
    href: "/gallery",
    image:
      "https://res.cloudinary.com/CLOUD_NAME/image/upload/f_auto,q_auto,w_800/gachericreates/home/entry-gallery",
  ...
  },
  {
    href: "/prints",
    image:
      "https://res.cloudinary.com/CLOUD_NAME/image/upload/f_auto,q_auto,w_800/gachericreates/home/entry-prints",
  ...
  },
  {
    href: "/safaris",
    image:
      "https://res.cloudinary.com/CLOUD_NAME/image/upload/f_auto,q_auto,w_800/gachericreates/home/entry-safaris",
