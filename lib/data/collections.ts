...
export const collections: Collection[] = [
  {
    ...
    coverImage:
      "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/great-migration/cover",
    description:
    ...
    images: [
      {
        src: "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/great-migration/001",
        alt: "Wildebeest crossing the Mara River at dawn, dust rising in the early light",
        title: "First Light Crossing",
        location: "Masai Mara, Kenya",
      },
      {
        src: "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/great-migration/002",
  ...
  },
  {
    ...
    title: "Big Cats",
    coverImage:
      "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/big-cats/cover",
    description:
      "Lions, leopards, and cheetahs — Kenya's top predators photographed in their natural rhythm, not in pursuit.",
    images: [
      {
        src: "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/big-cats/001",
        alt: "Female leopard resting in a fever tree at golden hour, Samburu",
        title: "The Fever Tree",
        location: "Samburu, Kenya",
      },
      {
        src: "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/big-cats/002",
  ...
  },
  {
    ...
    title: "Landscapes",
    coverImage:
      "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/landscapes/cover",
    description:
      "Kenya's geography is extraordinary — from the Rift Valley floor to the Aberdare highlands. These are places as characters.",
    images: [
      {
        src: "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/landscapes/001",
        alt: "Dawn mist over Lake Nakuru with flamingos forming a pink line at the water's edge",
        title: "Pink Dawn",
        location: "Lake Nakuru, Kenya",
      },
      {
        src: "https://res.cloudinary.com/CLOUD_NAME/image/upload/gachericreates/collections/landscapes/002",
